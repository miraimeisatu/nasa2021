...
map.on("mousemove", "2DmeshLayer", function(e) {
  ...
  popup.setLngLat(e.lngLat)
    .setHTML(
      "<div><b>COVIT-19 &nbsp;</b>" + e.features[0].properties.SHICODE + "</div>" + 
      "<div><b>Positive Risk (10/4/2021)</b></div>" + 
...
function updateTooltip({x, y, object}) {
  ...
  if (object) {
    ...
    tooltip.innerHTML = `
      ...
      <div><b>Positive Risk People</b></div>
      <div>${Math.round(object.properties.PT0_2050)}人口</div>
      `;
  } else { 
    tooltip.innerHTML = '';
  }
